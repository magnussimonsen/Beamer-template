...
\begin{itemize}
    \item vector addition: $\boldsymbol{+: V \times V \to V}$,
    \item scalar multiplication: $\boldsymbol{\cdot: \mathbb{F} \times V \to V}$,
\end{itemize}
...
\begin{graybox*}{Task for Exploration}
